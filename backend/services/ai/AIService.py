...
DEFAULT_SYSTEM_PROMPT = (
    "You are an AI document processing assistant for ToStructured AI. "
    "Help users analyze their documents, extract structured data, "
    "and answer questions about their uploaded content using RAG."
)
...
class AIService(IServiceManagerBase):
    ...
    def run_task(self, request):
        ...
        if task_type == "chat":
            return self.chat(
                request.get("message", ""), request.get("session_id", ""),
                request.get("user_id", ""), request.get("conversation_history"),
