"""Unified DocumentRepository — wraps any IRepository, backend-agnostic."""
from typing import List, Optional
from abstractions.IRepository import IRepository
from abstractions.IDocumentRepository import IDocumentRepository
...
class DocumentRepository(IDocumentRepository):
    ...
    def find_by_status(self, user_id: str, status: str) -> List[dict]:
        docs = self._repo.find_by("user_id", user_id)
