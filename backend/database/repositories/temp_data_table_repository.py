"""Unified TempDataTableRepository — wraps any IRepository, backend-agnostic."""
from typing import List, Optional
from abstractions.IRepository import IRepository
from abstractions.ITempDataTableRepository import ITempDataTableRepository


class TempDataTableRepository(ITempDataTableRepository):
    ...
    # -- TempDataTable-specific methods --
