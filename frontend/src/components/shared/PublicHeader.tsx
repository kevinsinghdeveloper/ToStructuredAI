      ...
      <Container maxWidth="lg">
        <Toolbar disableGutters sx={{ minHeight: 64 }}>
          <Box
            ...
            onClick={() => navigate('/')}
          >
            <DocIcon sx={{ color: 'primary.main', mr: 1, fontSize: 28 }} />
            <Typography
              variant="h6"
          ...
          <Box sx={{ flexGrow: 1, display: 'flex', gap: 1 }}>
            ...
            <Button
              color={isActive('/pricing') ? 'primary' : 'inherit'}
              onClick={() => navigate('/pricing')}
              sx={{ color: isActive('/pricing') ? 'primary.main' : 'text.secondary', textTransform: 'none' }}
            >
              Pricing
            </Button>
          </Box>
